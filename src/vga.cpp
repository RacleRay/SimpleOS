...
void VideoGraphicsArray::WriteRegisters(uint8_t* registers) {
    ...
    /* cathode ray tube controller: 阴极射线管显示控制器 */
    ...
    // maybe get wrong data by accidently override thess registers.
    // So write again.
...
void VideoGraphicsArray::PutPixel(int32_t x, int32_t y, uint8_t colorindex) {
    ...
    // at VideoGraphicsArray::SupportsMode, we set width == 320 && height == 200 && colordepth == 8
